                        ...
                        <div class="col-sm-12">
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <img width="500" height="500"
                                    src="<?= BASE_URL . '/post_images/' . $post['image'] ?>" />
                                <?= isset($errors['image']) ? "<span class='text-danger'>" . $errors['image'] . "</span>" : "" ?>
                                <label>Publish date<input type="date" name="publish_date" class="form-control"
                                        value="<?= date('Y-m-d', strtotime($post['publish_date'])) ?>"></label>

            ...
            <div class="col-lg-12">
                <div class="all-blog-posts">
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6"> <a class="btn btn-primary" href="export.php"
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th>Tags</th>
                                    <th>Image</th>
                                    <th><a href="<?= getSortingUrl('publish_date', $order_field, $order_by, $q) ?>">Publish
                                            Date <?= getSortFlag('publish_date', $order_field, $order_by) ?></a></th>
                                    <th>Actions</th>
                                </tr>
                            </thead>
                            <tbody>

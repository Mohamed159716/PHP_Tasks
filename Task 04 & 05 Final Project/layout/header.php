...
if (str_contains($_SERVER['REQUEST_URI'], '/login')) $current_page = 'login';
if (str_contains($_SERVER['REQUEST_URI'], '/register')) $current_page = 'register';

// print_r($_SERVER['REQUEST_URI']);
// echo str_contains($_SERVER['REQUEST_URI'], '/admin');
// die();
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?= ($current_page == 'admin' ? "active" : "") ?>"
                                href="<?php echo BASE_URL . "/admin" ?>">Admin</a>
                            <?= ($current_page == 'admin' ? "<span class='sr-only'>(current)</span>" : "") ?>
                        </li>
                        <?php
                            }
                            ?>
